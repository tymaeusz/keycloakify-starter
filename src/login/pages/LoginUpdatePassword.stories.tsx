...
export const WithPasswordErrorPtBr: Story = {
    render: () => (
        <KcPageStory
            kcContext={{
                locale: { currentLanguageTag: "pt-BR" },
                ...
                messagesPerField: {
                    existsError: (field: string) => field === "password",
                    get: () => "A senha deve ter pelo menos 8 caracteres."
                },
                isAppInitiatedAction: false
            }}
        />
...
export const WithPasswordConfirmErrorPtBr: Story = {
    render: () => (
        <KcPageStory
            kcContext={{
                locale: { currentLanguageTag: "pt-BR" },
